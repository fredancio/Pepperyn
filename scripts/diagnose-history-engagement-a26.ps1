...
$source = 'C:\Users\ADMIN-FRED\Documents\Codex\Pepperyn-development\backend\sandbox\diagnose_history_engagement.py'
$python = 'C:\Users\ADMIN-FRED\Documents\Codex\Pepperyn-runtime\fresh-founder-20260907-075758\backend-venv\Scripts\python.exe'
$expected = '4DAAD555DFB4ECF12FF84C51756805424BB8E4BB6B446FA66FB2A288EDB0E684'
...
try {
    ...
    if ($CheckOnly) {
        Write-Output 'A26_ENGAGEMENT_DIAGNOSTIC_PREFLIGHT: PASS. No secrets read; no network; no writes.'
        $exitCode = 0
    } else {
        ...
        $expectedStatus = 'A26_ENGAGEMENT_DIAGNOSED'
    ...
    Write-Output "A26_ENGAGEMENT_DIAGNOSTIC_REFUSED_STAGE: $stage"
