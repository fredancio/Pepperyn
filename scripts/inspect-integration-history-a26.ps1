...
$source = 'C:\Users\ADMIN-FRED\Documents\Codex\Pepperyn-development\backend\sandbox\inspect_populated_history_scope.py'
$python = 'C:\Users\ADMIN-FRED\Documents\Codex\Pepperyn-runtime\fresh-founder-20260907-075758\backend-venv\Scripts\python.exe'
$expected = 'D5EE7BFA36A6DE4807E20D4E9275CF408A0E1261096D802DFB230A3D94CE415B'
...
try {
    ...
    if ($CheckOnly) {
        Write-Output 'A26_HISTORY_PREFLIGHT_PREFLIGHT: PASS. No secrets read; no network; no writes.'
        $exitCode = 0
    } else {
        ...
        $expectedStatus = 'A26_SCOPES_INSPECTED'
    ...
    Write-Output "A26_HISTORY_PREFLIGHT_REFUSED_STAGE: $stage"
