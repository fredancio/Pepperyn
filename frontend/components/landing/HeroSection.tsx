...
export function HeroSection() {
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      {/* ── Container ── */}
      <div className="relative max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 pt-20 lg:pt-[90px] pb-16 lg:pb-24">

        {/* ── Centered content ── */}
        <div className="flex flex-col items-center text-center gap-6 lg:gap-7 max-w-3xl mx-auto">

          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-[#1B73E8]/10 border border-[#1B73E8]/20 rounded-full">
          ...
          <p style={{ fontSize: 'clamp(16px, 1.35vw, 20px)', lineHeight: 1.65, color: '#4a5878', maxWidth: 560 }}>
          ...
          <div className="border-t border-gray-100 pt-5 w-full max-w-xl">
          ...
          <div className="flex items-center justify-center gap-2" style={{ fontSize: 13, color: '#8a9bb0' }}>
